...
import "./DungeonAideDescription.css";

export default function DungeonAideDescription() {
    return (
        <section className="dungeonAide">
            <h2 id="dungeonAide-h2">What is Dungeon Aide?</h2>
            <p id="dungeonAide-p">
